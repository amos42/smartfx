...
{
//HWND hEditBox = CreateWindow( __TEXT("edit"), __TEXT("xxx"), WS_CHILD, 0, 0, 100, 40, hWnd, (HMENU)NULL, g_hInst, NULL );
//SendMessage( hEditBox, EM_SETMARGINS, EC_LEFTMARGIN | EC_RIGHTMARGIN, MAKELONG( 2, 2 ) );
//ShowWindow( hEditBox, SW_SHOW );
//SetFocus( hEditBox );
//atUI_OIC hEditBox = atUIAPI_CreateOIC(	0, 0, 100, 20 );
//atUIAPI_ShowAndSetFocusOIC(hEditBox);
