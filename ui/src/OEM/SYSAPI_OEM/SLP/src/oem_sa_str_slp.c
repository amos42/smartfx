...
{
	return strcasecmp( str1, str2 ); // strncasecmp
}
...
{
	// 구현이 미심쩍음. 나중에 확인 필요. 현재로선 기능 구현에 반영 안 되어 있음.
	wchar_t *ptr;
	return (atWCHAR *)wcstok( str, (const wchar_t *)sapr, &ptr );
}
