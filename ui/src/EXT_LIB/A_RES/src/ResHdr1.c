...
/***************************
  리소스를 생성한다.
****************************/
atHRESOURCE atRES_CreateResource_ver1( const atLPVOID DataPtr, atLONG DataSize, atINT SrcType, atRESFUNCS *lpFuncs )
{
...
리소스 정보를 얻는다.
****************************/
atBOOL atRES_GetResourceInfo_ver1(atHRESOURCE hResource, atRES_RESOURCE_INFO *lpResInfo)
{
...
/***************************
  리소스의 소스를 지정한다.
****************************/
atBOOL atRES_SetResourceSource_ver1( atHRESOURCE hResource, atLPVOID DataPtr, atLONG DataSize, atINT SrcType )
{
	atRES_RESOURCE_INFO *pRes = (atRES_RESOURCE_INFO *)hResource;
	RESOURCE_HEADER rh;
...
/***************************
  리소스의 헤더 캐쉬를 갱신한다.
****************************/
atBOOL atRES_PrepareResourceHeader_ver1( atHRESOURCE hResource )
{
	atRES_RESOURCE_INFO *pRes = (atRES_RESOURCE_INFO *)hResource;
	if( pRes == atNULL ) return atFALSE;
...
****************************/
atINT  atRES_GetFileCount_ver1( atHRESOURCE hResource )
{
	atRES_RESOURCE_INFO *pRes = (atRES_RESOURCE_INFO *)hResource;
...
****************************/
atLONG  atRES_GetFATOffset_ver1( atHRESOURCE hResource )
{
	atRES_RESOURCE_INFO *pRes = (atRES_RESOURCE_INFO *)hResource;
	if( pRes == atNULL ) return 0;
...
****************************/
atLONG  atRES_GetBaseOffset_ver1( atHRESOURCE hResource )
{
	atRES_RESOURCE_INFO *pRes = (atRES_RESOURCE_INFO *)hResource;
	if( pRes == atNULL ) return 0;
