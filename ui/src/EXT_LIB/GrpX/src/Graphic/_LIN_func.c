...
******************************************/
void __atGRPX_DrawLine0( atGRPX_CANVAS *lpCanvas, atINT StartX, atINT StartY, atINT EndX, atINT EndY,
                        atLONG ExParam1,
...
//   int x1, y1, x2, y2;
   ...
   clip = atGRPX_GetClipRect(lpCanvas);
    ...
    r = __atGRPX_GetClippedEdge( &StartX, &StartY, &EndX, &EndY, StartX, StartY, EndX, EndY, clip );
	if( r == -1 ) return;
