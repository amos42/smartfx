...
atVOID __atGRPX_DrawLine1( atGRPX_CANVAS *lpCanvas, atINT StartX, atINT StartY, atINT EndX, atINT EndY,	atGRPX_COLOR clrColor )
{
	atREAL x1, y1, x2, y2;
	atREAL dx, dy;
	atGRPX_PIXEL *pBuf;
...
atVOID __atGRPX_DrawLine1_REAL( atGRPX_CANVAS *lpCanvas, atREAL StartX, atREAL StartY, atREAL EndX, atREAL EndY, atGRPX_COLOR clrColor )
{
	atREAL x1, y1, x2, y2;
	atREAL dx, dy;
	atGRPX_PIXEL *pBuf;
