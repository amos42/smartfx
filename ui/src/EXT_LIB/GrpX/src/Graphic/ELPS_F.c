...
/***************
  타원을 그린다.
****************/
void atGRPX_FillEllipse( atGRPX_CANVAS *lpCanvas, atINT nX, atINT nY, atINT RadiusX, atINT RediusY, atGRPX_COLOR Color )
{  
	...
	atGRPX_DrawHorizLine( lpCanvas, nX - x, nY - y, (x << 1), Color );  
	atGRPX_DrawHorizLine( lpCanvas, nX - x, nY + y, (x << 1), Color );  
