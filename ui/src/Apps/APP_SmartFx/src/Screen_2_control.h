...
#ifndef _SCREEN_2_CONTROL_H_INCLUDED
#define _SCREEN_2_CONTROL_H_INCLUDED
...
typedef struct _SCR_2_CONTROL_WNDDATA {
	atHBITMAP hBm_bg;
	//atHBITMAP hBm_title;
...
} SCR_2_CONTROL_WNDDATA, * LPSCR_2_CONTROL_WNDDATA;
