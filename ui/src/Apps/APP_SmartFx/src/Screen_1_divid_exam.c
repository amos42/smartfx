...
static SCR_1_RECOVER_EXAM_WNDDATA	recoverWndData;
static SCR_1_DESC_WNDDATA			descripWndData;
static SCR_INFORMATION_WNDDATA		inforData;
static SCR_CALCULATE_WNDDATA		calcuData;

static void Scr_1_Divid_Exam_WndOnCommand(atHWINDOW hWnd, long nParam1, long nParam2)
{
	LPSCR_1_DIVID_EXAM_WNDDATA lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
    ...
    switch(nParam1)
    {
		...
		case 1001:
		{
			memset(&recoverWndData, 0, sizeof(SCR_1_RECOVER_EXAM_WNDDATA));

			if (lpData->nType == 101) {
				recoverWndData.nType = 101;
			}
			else if (lpData->nType == 102) {
				recoverWndData.nType = 102;

				LedControl(atFALSE);
			}

			wnd = atAPP_CreateWindow(atAPPMNG_GetCurApp(), atNULL, 0, atNULL, _AT(""), 0, 0, 0, 0, sizeof(SCR_1_RECOVER_EXAM_WNDDATA), Scr_1_Recover_Exam_WndOnEvent, &recoverWndData, atNULL);
			atWINDOW_SetAnchor(wnd, 0, 0, 0, 0);
			atAPP_ShowWindow(atAPPMNG_GetCurApp(), wnd, atTRUE);
...
static void Scr_1_Divid_Exam_WndOnTimer(atHWINDOW hWnd, long nParam1, long nParam2)
{
	LPSCR_1_DIVID_EXAM_WNDDATA lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
    ...
    {
        case 0x100 :
			//nBettery = GetBatteryValue();
			atWINDOW_Refresh(hWnd);
			break;
	}
}

static void Scr_1_Divid_Exam_WndOnChange(atHWINDOW hWnd, long nParam1, long nParam2)
{
	LPSCR_1_DIVID_EXAM_WNDDATA lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
...
static void Scr_1_Divid_Exam_WndOnInit(atHWINDOW hWnd)
{
	LPSCR_1_DIVID_EXAM_WNDDATA	lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
	...
	//lpData->hBm_title = atUIAPI_CreateBitmapFromRes(hResSrc, _AT("Scr_1_divid_title.img"));
	...
	lpData->hBm_btn_calcu_n = atUIAPI_CreateBitmapFromRes(hResSrc, _AT("Scr_1_divid_btn_center_n.img"));
	lpData->hBm_btn_calcu_p = atUIAPI_CreateBitmapFromRes(hResSrc, _AT("Scr_1_divid_btn_center_p.img"));
...
static void Scr_1_Divid_Exam_WndOnRelease(atHWINDOW hWnd)
{
	LPSCR_1_DIVID_EXAM_WNDDATA	lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
...
static int Scr_1_Divid_Exam_WndOnKeyDown(atHWINDOW hWnd, int nKeyCode)
{
	LPSCR_1_DIVID_EXAM_WNDDATA lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
	atHWINDOW hPopup;
...
static int Scr_1_Divid_Exam_WndOnKeyPress(atHWINDOW hWnd, int nKeyCode)
{
	LPSCR_1_DIVID_EXAM_WNDDATA lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
...
static void Scr_1_Divid_Exam_WndOnPaint(atHWINDOW hWnd)
{
	LPSCR_1_DIVID_EXAM_WNDDATA lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
...
int Scr_1_Divid_Exam_WndOnEvent(atHWINDOW hWnd, int nMsg, long nParam1, long nParam2)
{
	int ret = 0;

	LPSCR_1_DIVID_EXAM_WNDDATA	lpData = (LPSCR_1_DIVID_EXAM_WNDDATA)atWINDOW_GetDataPtr(hWnd);
	LPSCR_1_DIVID_EXAM_WNDDATA  Data = (LPSCR_1_DIVID_EXAM_WNDDATA)nParam1;
	...
	switch( nMsg )
	{
		case WNDMSG_INIT:
		{
			...
			Scr_1_Divid_Exam_WndOnInit(hWnd);
		}
			break;

		case WNDMSG_RELEASE:
			Scr_1_Divid_Exam_WndOnRelease( hWnd );
			break;

		case WNDMSG_PAINT:
			Scr_1_Divid_Exam_WndOnPaint( hWnd );
			break;

		case WNDMSG_KEYDOWN:
			return Scr_1_Divid_Exam_WndOnKeyDown( hWnd, nParam1 );
			break;

		case WNDMSG_KEYPRESS:
			return Scr_1_Divid_Exam_WndOnKeyPress( hWnd, nParam1 );
			break;

		case WNDMSG_CHANGE:
			Scr_1_Divid_Exam_WndOnChange( hWnd, nParam1, nParam2 );
			break;

		case WNDMSG_COMMAND:
			Scr_1_Divid_Exam_WndOnCommand( hWnd, nParam1, nParam2 );
			break;

		case WNDMSG_TIMER:
			Scr_1_Divid_Exam_WndOnTimer( hWnd, nParam1, nParam2 );
			break;
