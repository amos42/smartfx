...
void APP_Entry_Init( void *hInst, void *hWnd, void *pHeap, long heap_size, int width, int height, void *pScreenBuffer, void *pResPtr, long nResSize )
{
	...
	atAPPMNG_SetCurApp( atAPP_CreateApplication(16*1024*1024) );
...
//	return;
	...
	hWnd = atAPP_CreateWindow( atAPPMNG_GetCurApp(), atNULL, 0, atWS_FRAMEWINDOW | atWS_UNFOCUSGRAY, _AT("Main Window"), 5, 5, 80, 80, sizeof(MAINWNDDATA), MainWndOnEvent, atNULL, atNULL );
